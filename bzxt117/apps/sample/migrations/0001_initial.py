    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txtHandledURL', models.CharField(blank=True, max_length=300, null=True, verbose_name='处理过的TXT文档路径')),
        ...
        migrations.CreateModel(
            name='devPartSampleRamanTestFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('txtURL', models.FileField(blank=True, max_length=300, null=True, upload_to='file/devPartSampleRamanTestFile/', verbose_name='录入TXT文档路径')),
                ('txtHandledURL', models.CharField(blank=True, max_length=300, null=True, verbose_name='处理过的TXT文档路径')),
                ('devPartSampleRaman', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devPartSampleRamanTestFile', to='sample.devPartSampleRaman', verbose_name='对应的Raman检测')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handledURL', models.CharField(blank=True, max_length=300, null=True, verbose_name='有效元素列表')),
        ...
        migrations.CreateModel(
            name='exploSampleGCMSFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('txtHandledURL', models.CharField(blank=True, max_length=300, null=True, verbose_name='处理过的TXT文档路径')),
                ('exploSampleGCMS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exploSampleGCMSFile', to='sample.exploSampleGCMS', verbose_name='对应的GC-MS检测')),
            ],
            options={
                'verbose_name': '炸药及原材料样本GC-MS检测文件表 ',
                'verbose_name_plural': '炸药及原材料样本GC-MS检测文件表 ',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inputDate', models.DateTimeField(default=datetime.datetime.now, verbose_name='录入日期')),
                ('rectCoordi', models.CharField(blank=True, max_length=50, null=True, verbose_name='矩形框坐标（2个）')),
