    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txtURL', models.FileField(blank=True, max_length=300, null=True, upload_to='file/devEviFTIRTestFile/', verbose_name='录入TXT文档路径')),
        ...
        migrations.CreateModel(
            name='exploEviGCMSFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exploEviId', models.IntegerField(blank=True, null=True, verbose_name='所涉及的炸药物证')),
                ('txtHandledURL', models.CharField(blank=True, max_length=300, null=True, verbose_name='处理过的TXT文档路径')),
                ('exploEviGCMS', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exploEviGCMSFile', to='evi.exploEviGCMS', verbose_name='对应的GC-MS检测')),
            ],
            options={
                'verbose_name': '炸药及原材料物证GC-MS检测文件表',
                'verbose_name_plural': '炸药及原材料物证GC-MS检测文件表',
            },
        ),
        migrations.CreateModel(
