# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-24 03:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devShapeEvi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMatchEvi', to='evi.devShapeEvi', verbose_name='对应的形态物证')),
                ('devShapeSample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMatchSample', to='sample.devShapeSample', verbose_name='对应的形态样本')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkHandle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMultiMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ('devEvi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMultiMatch', to='evi.devEvi', verbose_name='对应的物证')),
                ('devPartSample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMultiMatch', to='sample.devPartSample', verbose_name='对应的样本')),
                ('expertHandle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMultiMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
            ],
            options={
                'verbose_name': '爆炸装置物证形态综合匹配结果表',
                'verbose_name_plural': '爆炸装置物证形态综合匹配结果表',
                'ordering': ['-Score'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('devShapeMultiMatch', models.CharField(blank=True, max_length=300, null=True, verbose_name='对应的形态匹配id数组')),
                ('devCompMatch', models.CharField(blank=True, max_length=300, null=True, verbose_name='对应的成分匹配id数组')),
                ('devEvi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devSynMatch', to='evi.devEvi', verbose_name='\t对应的物证（外键）')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exploSynMatch', models.CharField(blank=True, max_length=300, null=True, verbose_name='对应的综合匹配id数组')),
