    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devCompMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ...
                ('expertHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devCompMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devPartRamanTestFile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devMatchRaman', to='sample.devPartRamanTestFile', verbose_name='对应的样本Raman文件记录')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='普通用户核准状态')),
                ('isExpertCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='专家核准状态')),
                ('checkHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ...
                ('expertHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devShapeMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkHandleComp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devSynMatchcheckHandleComp', to=settings.AUTH_USER_MODEL, verbose_name='成分普通核准人员（外键）')),
                ('checkHandleShape', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devSynMatchcheckHandleShape', to=settings.AUTH_USER_MODEL, verbose_name='图像普通核准人员（外键）')),
                ...
                ('expertHandleComp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devSynMatchexpertHandleComp', to=settings.AUTH_USER_MODEL, verbose_name='成分专家核准人员（外键）')),
                ('expertHandleShape', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devSynMatchexpertHandleShape', to=settings.AUTH_USER_MODEL, verbose_name='图像专家核准人员（外键）')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Score', models.FloatField(default=0.0, verbose_name='相似分')),
                ('exploEviGCMSTestFile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exploMatchGCMS', to='evi.exploEviGCMSTestFile', verbose_name='对应的物证GC-MS文件记录')),
                ('exploSampleGCMSTestFile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exploMatchGCMS', to='sample.exploSampleGCMSTestFile', verbose_name='对应的样本GC-MS文件记录')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='普通用户核准状态')),
                ('isExpertCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='专家核准状态')),
                ('checkHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logoImgMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ('expertHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logoImgMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='普通用户核准状态')),
                ('isExpertCheck', models.IntegerField(choices=[(1, '未核准'), (2, '匹配'), (3, '非匹配')], default=1, verbose_name='专家核准状态')),
                ('checkHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='oPartImgMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ('expertHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='oPartImgMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PCBImgMatchcheckHandle', to=settings.AUTH_USER_MODEL, verbose_name='普通核准人员（外键）')),
                ('expertHandle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PCBImgMatchexpertHandle', to=settings.AUTH_USER_MODEL, verbose_name='专家核准人员（外键）')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='exploreportmatch',
            unique_together=set([('exploSample', 'exploEvi')]),
        ),
        migrations.AlterUniqueTogether(
            name='explomatchxrf',
        ...
        migrations.AlterUniqueTogether(
            name='explomatchgcms',
            unique_together=set([('exploSampleGCMSTestFile', 'exploEviGCMSTestFile')]),
        ),
        migrations.AlterUniqueTogether(
            name='explomatchftir',
        ...
        migrations.AlterUniqueTogether(
            name='devsynmatch',
            unique_together=set([('devEviComp', 'devPartSampleComp', 'devPartSampleShape', 'devEviShape')]),
        ),
        migrations.AlterUniqueTogether(
            name='devmatchxrf',
        ...
        migrations.AlterUniqueTogether(
            name='devmatchraman',
            unique_together=set([('devPartRamanTestFile', 'devEviRamanTestFile')]),
        ),
        migrations.AlterUniqueTogether(
            name='devmatchftir',
